/**
 * Author: https://github.com/zdresearch
 * Date: 2018/09/18
 * Avaliability: https://github.com/zdresearch/s3-multipart-upload-javascript-browser
 * License: MIT
 */
...
function S3MultiUpload(file) {
    ...
    this.SERVER_LOC = '/s3/api/v1.0'; // Location of the server
